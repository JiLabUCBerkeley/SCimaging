function [result,output]=OSCriteria(handles,criteria)
if nargin==1
...
OS.fitFlag=0; % option to use fitted data or raw df/f to caluclate OSI itself; 
...
OS=criteria.OS;
annovaFlag=OS.annovaFlag;
fitFlag=OS.fitFlag;
goodFitFlag=OS.goodFitFlag;
gOSI_OSI=OS.gOSI_OSI;   
...
%% whether to use gOSI>0.25 (default value of gOSI_OSI(1)=0.25) as a standard (when gOSI_OSI(3)=1) 
%or to use OSI>0.5 (defaut value of gOSI_OSI(2)=0.5), when gOSI_OSI(3)=2; 
