function [rgbImg,map2]=mapHSV_180Degrees(img,angleMap,input)
if nargin>2 && input.lhFlag==1
...
for ii=1:m1
    for jj=1:n1
        if angleMap2(ii,jj)>0.5
            angleMap2(ii,jj)=angleMap2(ii,jj)-0.5;
        end
    end
end
if nargin==2
...
if isfield(input,'fullColor')
    if input.fullColor==1
        angleMap2=angleMap2*2;
    end
